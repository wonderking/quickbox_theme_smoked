                ...
                <table id="dataTable1" class="table table-bordered table-striped-col" style="font-size: 12px">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <?php } else { ?>
                        <td style="vertical-align: middle; text-align: center"><a href="?installpackage-plexrequests=true" data-toggle="modal" data-target="#sysResponse" id="plexrequestsInstall" class="btn btn-xs btn-default"><?php echo T('INSTALL'); ?></a></td>
                      <?php } ?>
                    </tr>
                    <tr>
                      <td>pyLoad</td>
          ...
          <div class="row">
            ...
            <div class="col-sm-12">
              <div id="project-commits" class="panel panel-inverse">
                <div class="panel-heading">
                  <h4 class="panel-title text-success"><?php echo T('RECENT_UPDATES'); ?> <small><a href="https://github.com/QuickBox/QuickBox/compare/v2.4.9...master" class="label label-primary" style="font-size:10px; padding-top:0; padding-bottom:0px; top: -2px; position: relative;" target='_blank'>QuickBox :: <span style="color: #fff;text-shadow: 0px 0px 6px #fff;"><?php echo "$version"; ?></span></a></small></h4>
                </div>
